  ...
  const sendTelegramNotification = async (formData) => {
    ...
    try {
      ...
      if (!telegramResponse.ok) {
        console.error(
          `Telegram HTTP error! status: ${telegramResponse.status}`
        );
      } else {
        ...
        <div className="container-2">
          <div className="lists">
            <div className="list-1">
              ...
              <p>
                We are honored to have been recognized as the #1 travel company
                in the area for the past twenty-five years, renowned for our
                exceptional hospitality, services, and transportation. Our
                commitment is to provide personalized attention to both leisure
                and business travelers, ensuring that all your needs are met.
              </p>
              <div className="social">
                <h6 className="title">Approved and Accredited By</h6>
                <img
                  src="/assests/approved-by-tourism-india-himachal.png"
                  alt="Approved by Tourism India Himachal"
                />
              </div>
            </div>
            <div className="list-2">
              <ul>
                ...
                <li>
                  <a href="/#locations">Popular Locations</a>
                </li>
                <li>
            ...
            <div className="list-3">
              <div className="properties">
                ...
                <a href="#">
                  ...
                  <p>We Are Leading Travel consulting Agency</p>
                </a>
                <a href="#">
                  <img src="/assests/g8.jpg" alt="" />
                  <p>Top 10 Places In Himachal</p>
                </a>
                <a href="#">
                  <img src="/assests/g9.jpg" alt="" />
                  <p>10 Things to Consider While Visiting Himachal</p>
                </a>
              </div>
            </div>
          ...
          <div className="footer-bottom">
            <p>
              © 2021 My Bharat Trips. All rights reserved | Designed by{" "}
              <a href="#">himachaltourguide.co.in</a>
            </p>
          </div>
        </div>
      </div>
